...
function buildAttribsString(attribs) {
	return attribs && attribs.length
		? htmlsafe(util.format('(%s) ', attribs.join(', ')))
		: ''
}
...
function generateSourceFiles(sourceFiles, encoding) {
	...
	;(0, _keys2.default)(sourceFiles).forEach(function(file) {
		var source
	...
	if (items && items.length) {
		items
			.filter(function(item) {
				return !(item.viewmeta && item.viewmeta.navigation === false)
			})
...
exports.publish = function(taffyData, opts, tutorials) {
	...
	;(0, _keys2.default)(helper.longnameToUrl).forEach(function(longname) {
