 ...
 * @returns {*}
 */
item => array.findIndex(value => value[stringKey] === ensureStringValue(item, stringKey));
 ...
 * @returns {*}
 */
(by, value) => (0, _util.recursify)(array, by, value);
 ...
 * @returns {*}
 */
name => (0, _util.recursify)(array, stringKey, ensureStringValue(name, stringKey));
...
(item, parent = null) => {
	if (parent) {
		return removeFrom(array, stringKey)(ensureStringValue(item, stringKey), parent);
	}
	const found = findIndex(array, stringKey)(ensureStringValue(item, stringKey));
 ...
 * @returns {boolean}
 */
item => (0, _util.recursify)(array, stringKey, ensureStringValue(item, stringKey)) !== null;
 ...
 */
const ensureStringValue = (object, key) => typeof object === 'object' ? object[key] : object;
